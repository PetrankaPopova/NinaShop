...
public class ValidationConstants {
    ...
    public final static String VARIABLE_LENGTH = "Name must contain at least 3 characters!";

    public final static String VARIABLE_ZERO = "Variable must be > 0 !";
